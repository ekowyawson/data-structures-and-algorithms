...
const addOne = (arr) => {
  // Create a new array to store the incremented numbers
  let result = [];

  // Use forEach loop to iterate through each element in the input array
  arr.forEach(function(number) {
    // Increment each number by 1 and push it to the result array
    result.push(number + 1);
  });

  // Return the new array with incremented numbers
  return result;
};
...
const addExclamation = (arr) => {
  ...
  arr.forEach(function(str) {
    // Concatenate "!" to each string and push it to the result array
    result.push(`${str}!`);
  });

  // Return the new array with modified strings
  return result;
};
...
const allUpperCase = (arr) => {
  ...
  // Use forEach loop to iterate through each element in the input array
  arr.forEach(function(str) {
    // Convert each string to uppercase and push it to the result array
    result.push(str.toUpperCase());
  });

  // Return the new array with uppercase strings
  return result;
};
